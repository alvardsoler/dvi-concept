...
public class PlayerControl : MonoBehaviour
{
    ...
    {
        Debug.Log("shooting");                
            Rigidbody instProject = Instantiate(projectile, transform.position, transform.rotation) as Rigidbody;
            instProject.velocity = transform.TransformDirection(new Vector3(0, 0, speedProjectile));
